const ENTRIES = [
  {
    ...
    items: [
      ...
      'Khối "DCA tốn bao nhiêu tiền so với đầu tư một lần?" giờ đếm mốc thời gian được theo hai kiểu, chuyển qua lại bằng nút. Kiểu cũ đếm tổng thời gian từ ngày bắt đầu, nên dòng "1 năm" khi DCA 12 tháng nghĩa là mua xong phát cuối rồi bán luôn, không giữ thêm ngày nào. Kiểu mới đếm số năm giữ thêm sau lần mua cuối, hợp với người rải tiền xong thì giữ dài hạn, và không mốc nào bị bỏ trống vì chưa DCA xong.',
